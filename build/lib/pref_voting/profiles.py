...
class Profile(object):
    ...
    def rankings(self): 
        """
        Returns a list of all the rankings in the profile (one ranking for each voter).   The type is a list of tuples of integers. 
        """
    ...
    def display_latex(self, cmap = None, curr_cands = None):
        """Display a profile (restricted to ``curr_cands``) as a LaTeX table (use the provided ``cmap`` or the ``cmap`` associated with the profile).
        ...
        .. exec_code::
            ...
            prof.display_latex()
            print()
            prof.display_latex(cmap={0:"a", 1:"b", 2:"c"})
